...
9. **`zig-expert`**: Activate when Zig context is detected (`build.zig`, `build.zig.zon`, `*.zig`, Zig tooling). Pin the release first (`zig version`, `.minimum_zig_version`); Zig is pre-1.0.
