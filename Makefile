...
configure: ## Run the configuration script
	...
	@printf "\033[1;32m Configuring Piraz's AI Sandbox Environment\033[0m\n"
	@printf "\033[1;34m=========================================\033[0m\n\n"
	@./scripts/configure
	@printf "\n\033[1;34mConfiguration complete.\033[0m\n"

sandbox: ## Build the Piraz's AI Sandbox container image
	@printf "\n"
	@printf "\033[1;34m=========================================\033[0m\n"
	@printf "\033[1;33m Building Piraz's AI Sandbox Image\033[0m\n"
	@printf "\033[1;34m=========================================\033[0m\n\n"
